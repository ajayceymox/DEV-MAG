<?php
namespace Zazmic\AmazonMCF\Controller\Adminhtml\Setup\Disconnect;

/**
 * Interceptor class for @see \Zazmic\AmazonMCF\Controller\Adminhtml\Setup\Disconnect
 */
class Interceptor extends \Zazmic\AmazonMCF\Controller\Adminhtml\Setup\Disconnect implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $request, $resultPageFactory, $redirectFactory, $cacheTypeList, $mcfStoreManager, $mcfLogManager);
    }
